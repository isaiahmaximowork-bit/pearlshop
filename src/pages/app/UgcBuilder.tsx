...
const UgcBuilder = () => (
  <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6">
    <div className="text-center space-y-4 max-w-md">
      ...
      <h1 className="text-3xl font-black tracking-tight">UGC Avatar Gen</h1>
      ...
      <p className="text-muted-foreground text-sm">
        Estamos trabalhando nessa funcionalidade. Em breve você poderá criar avatares UGC personalizados.
      </p>
    </div>
  </div>
);

export default UgcBuilder;
